...
class PacketSniffer:
    ...
    def update_plots(self):
        ...
        # Bar chart
        plt.subplot(1, 2, 1)
        plt.bar(self.packet_counts.keys(), self.packet_counts.values(),
    ...
    def packet_handler(self, packet):
        ...
        if packet.haslayer(IP):
            ...
            if packet.haslayer(TCP):
                ...
                print(f"Packet count: {self.packet_count} (Other IP protocol)")
                self.packet_counts['Others'] += 1
        else:
            # ✅ ARP / non-IP packets
            print(f"Packet count: {self.packet_count} (Non-IP packet)")
            self.packet_counts['Others'] += 1
